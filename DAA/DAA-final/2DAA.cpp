...
int main() {
    ...
    int freq[] = {3,2,1,1}; // Corresponding frequencies
    int size = sizeof(freq) / sizeof(freq[0]); // Calculate size of frequency array

    cout << "Huffman Codes:\n";
    HuffmanCode(data, freq, size); // Generate and print Huffman codes
    return 0;
}
